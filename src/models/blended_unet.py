...
# This model is a modified version of the BlendedUNet2DConditionModel from the
# diffusers library. The original code can be found at: 
...
class BlendedUNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    r"""
    ...
    def forward(
        ...
        # CHECK: if we need to add the class embeddings to the encoder_hidden_states
        ...
        # BLEND: process the embedding for the encoder part of the unet
        encoder_hidden_states = self.process_encoder_hidden_states(
            encoder_hidden_states=encoder_hidden_states, added_cond_kwargs=added_cond_kwargs
        )
       
        # BLEND: process the embedding for the decoder part of the unet 
        decoder_hidden_states = self.process_encoder_hidden_states(
            encoder_hidden_states=decoder_hidden_states, added_cond_kwargs=added_cond_kwargs
        )
        ...
        # 3. down
        # BLEND: here we pass the embeddings of the first prompt
        ...
        # 4. mid BLEND: here we could argue that we should pass the embeddings
        # of the first or second prompt, for now we pass the embeddings of the first prompt
